...
public class CustomConfigurer extends DispatcherConfigurer {
    ...
    public static final class Factory {
        ...
        @Inject
        public Factory(JavaPlugin plugin, WaypointArgumentMapper.Provider provider, Set<CommandCondition> conditions) {
            this.plugin = plugin;
        ...
        public DispatcherConfigurer create(CommandManager commandManager) {
            return new CustomConfigurer(this.plugin, this.provider, this.conditions, commandManager);
        }
    }
}
